...
CREATE TABLE `players` (
	...
	`last_joined_date` text DEFAULT CURRENT_TIMESTAMP NOT NULL
);
...
--> statement-breakpoint
INSERT INTO `__new_users`("id", "name", "email", "email_verified", "image", "created_at", "updated_at", "username", "display_username") SELECT "id", "name", "email", "email_verified", "image", "created_at", "updated_at", "username", "display_username" FROM `users`;--> statement-breakpoint
