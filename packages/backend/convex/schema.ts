...
export default defineSchema({
  ...
  kits: defineTable({
    ...
    armorItems: v.object({
      helmet: v.optional(v.union(v.null(), v.string())),
      chestplate: v.optional(v.union(v.null(), v.string())),
      leggings: v.optional(v.union(v.null(), v.string())),
      boots: v.optional(v.union(v.null(), v.string())),
    }),
  }).index("by_kit_id", ["kitId"]),
