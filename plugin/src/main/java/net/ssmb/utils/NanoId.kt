...
// Stripped down version of the original NanoId class
//  https://github.com/viascom/nanoid-kotlin
...
object NanoId {
     ...
     */
    private fun calculateStep(size: Int, alphabet: String, additionalBytesFactor: Double = calculateAdditionalBytesFactor(alphabet)) =
