...
/**
 * Kotlinx serialization deserializer for Bukkit Sound enum
 * Serializes/deserializes Sound as string key names
 */
object SoundSerializer : KSerializer<Sound> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("Sound", PrimitiveKind.STRING)

    private val soundRegistry = RegistryAccess.registryAccess().getRegistry(RegistryKey.SOUND_EVENT)

    override fun serialize(encoder: Encoder, value: Sound) {
        val key = soundRegistry.getKey(value)
