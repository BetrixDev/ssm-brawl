...
fun List<dev.betrix.superSmashMobsBrawl.models.SpawnPoint>.getEquidistant(
    n: Int
): List<dev.betrix.superSmashMobsBrawl.models.SpawnPoint> {
    if (isEmpty() || n <= 0) {
        return emptyList()
    }
    ...
    val result = mutableListOf<dev.betrix.superSmashMobsBrawl.models.SpawnPoint>()
